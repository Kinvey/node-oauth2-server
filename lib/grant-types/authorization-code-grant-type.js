...
AuthorizationCodeGrantType.prototype.handle = function(request, client) {
  ...
  return Promise.bind(this)
    ...
    .tap(function(code){
      if(this.model.additionalAuthCodeProcessing && typeof this.model.additionalAuthCodeProcessing === 'function'){
        return promisify(this.model.additionalAuthCodeProcessing, 3).call(this.model, code, client, request);
      }
      return code;
    })
    .then(function(code) {
  ...
  return promisify(this.model.getAuthorizationCode, 1).call(this.model, request.body.code)
    .then(function(code) {
      ...
      if (code.client.id !== client.id) {
        throw new InvalidClientError('Invalid client: Client is not valid for this authorization code.');
      }
