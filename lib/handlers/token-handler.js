...
var grantTypes = {
  ...
  'urn:ietf:params:oauth:grant-type:jwt-bearer': require('../grant-types/jwt-grant-type')
};
...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  return promisify(this.model.getClient, 3).call(this.model, credentials.clientId, credentials.clientSecret, request)
    .then(function(client) {
      if (!client) {
